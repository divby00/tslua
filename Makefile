...
MYCFLAGS=-ggdb
MYLDFLAGS=
MYLIBS= -lSDL_mixer -lSDL_image -lSDL_gfx -lSDL
MYOBJS=
...
LIB_O=	lauxlib.o lbaselib.o lbitlib.o lcorolib.o ldblib.o liolib.o \
	...
	ts_cfg.o ts_ctr.o ts_debug.o ts_font.o ts_gfx.o\
	ts_lib.o ts_log.o ts_lua.o ts_malloc.o ts_timer.o ts_sfx.o\
	ts_world.o ts_translator.o
